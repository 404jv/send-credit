...
import { SendCreditController } from '../modules/statements/useCases/sendCredit/SendCreditController';
...
const sendCreditController = new SendCreditController();
...
statementRouter.post('/transfer/:user_id', sendCreditController.execute);
